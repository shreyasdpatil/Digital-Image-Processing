function [cntR,sumR,cntP,sumP] = new_edgesEvalImg( E, G, varargin )
...
%   for g = 1:n
    [matchE1,matchG1] = correspondPixels(E1,G,maxDist);
...
%   end
  ...
  FP=E1-matchE; TP=matchE; FN=(allG-matchG);
