...
flags.DEFINE_integer("use_num_images", 20000, "Num of images used for training")
FLAGS = flags.FLAGS
...
def main():
    ...
    kernel_sizes=saab1.parse_list_string(FLAGS.kernel_sizes)
    if FLAGS.num_kernels:
    	num_kernels=saab1.parse_list_string(FLAGS.num_kernels)
    else:
    	num_kernels=None
    ...
    pca_params=saab1.multi_Saab_transform(train_images, train_labels,
